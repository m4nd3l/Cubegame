...
public class GLFW {
    ...
    // MOUSE UTILS
    public static void hideMouseCursor(long glfwWindow) { glfwSetInputMode(glfwWindow, GLFW_CURSOR, GLFW_CURSOR_HIDDEN); }
    public static void showMouseCursor(long glfwWindow) { glfwSetInputMode(glfwWindow, GLFW_CURSOR, GLFW_CURSOR_NORMAL); }
    public static void setMouseCursorPosition(long glfwWindow, double x, double y) { glfwSetCursorPos(glfwWindow, x, y); }
